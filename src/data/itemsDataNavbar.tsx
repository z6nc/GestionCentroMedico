...
import { VistaCitas, VistaPacientes, VistaHistoriaMedica, VistaMedicos, VistaMedicamentos, VistaAnalisis } from "../pages/VistaAdmin/index"
...
export const sidebarItems: SidebarItem[] = [
    {
        ...
        itemsLabel: [
            ...
            { icon: Stethoscope, label: "Lista Medicos", path: "/dashboard/lista-medicos", element: <VistaMedicos />, allowedRoles: ["administrativo"] },
